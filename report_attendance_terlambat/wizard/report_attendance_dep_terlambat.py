...
class report_attendance_dep_terlambat(models.TransientModel):
    _name = 'report.attendance.dep.terlambat'
    ...
    def print_report(self):
        ...
        return self.env.ref('report_attendance_terlambat.report_attendance_dep_terlambat_xlsx').report_action(self, data=data)