...
class LevelOfApprovalLine(models.Model):
    ...
    # job_id = fields.Many2one('hr.job', string='Job Position', related='user_id.employee_id.job_id', tracking=True)
...
class ApprovalInformation(models.Model):
    ...
    sign_signature = fields.Binary(related="approve_user_id.sign_signature")
