odoo.define('custom_sale_order.QtyAtDateWidget', function (require) {
"use strict";
...
var QtyAtDateWidget = Widget.extend({
    template: 'custom_sale_order.qtyAtDate',
    ...
    async _openForecast(ev) {
        ...
        action.context = {
            ...
            warehouse: this.data.product_warehouse_id && this.data.product_warehouse_id.res_id,
    ...
    _getContent() {
        ...
        const $content = $(QWeb.render('custom_sale_order.QtyDetailPopOver', {
            data: this.data,
        }));
...
widget_registry.add('qty_at_date_widget_custom', QtyAtDateWidget);
