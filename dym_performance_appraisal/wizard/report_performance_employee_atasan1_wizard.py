...
class report_performance_employee_atasan1_wizard(models.TransientModel):
    _name = 'report.performance.employee.atasan1.wizard'
    _description = 'Report Performance Employee to Atasan 1 Wizard' 
    ...
    def print_report(self):
        ...
        return self.env.ref('dym_performance_appraisal.report_performance_employee_atasan1').report_action(self, data=data)