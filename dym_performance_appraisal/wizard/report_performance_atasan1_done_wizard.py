...
class report_performance_atasan1_done_wizard(models.TransientModel):
    _name = 'report.performance.atasan1.done.wizard'
    _description = 'Report Performance Atasan 1 to Posted Wizard' 
    ...
    def print_report(self):
        ...
        return self.env.ref('dym_performance_appraisal.report_performance_atasan1_done').report_action(self, data=data)